...
const POSTS = [
  ...
  },
  {
    ...
    body: [
      "There's a phase nobody talks about in fitness. You're not a beginner anymore. You're not where you want to be either. You're just... stuck. That was me from 19 to 21 and honestly it bled into every part of my life.",
          ...
          <div>
            ...
            >
              <a href={CAL_URL} target="_blank" rel="noopener noreferrer" style={{
                ...
                boxShadow: `4px 4px 0 ${INK}`, textDecoration: "none", display: "inline-block",
            ...
            <motion.div variants={fadeUp} className="results-card">
              ...
              <div style={{ padding: "28px 24px", display: "flex", flexDirection: "column", gap: 18, background: CREAM, color: INK }}>
                ...
                <div style={{ fontSize: 13, lineHeight: 1.75, color: INK, fontStyle: "italic", flex: 1 }}>
                  &ldquo;I was in a rough place, stressed with work, barely exercising, eating whatever I wanted. Too many bad habits made me so unhappy, I knew something had to change. Being coached was exactly what I needed. Having Tenhang in my corner keeps me accountable on the days I don&apos;t feel like doing anything. The results have been crazy. I feel bigger, less stressed and more confident. It&apos;s not just how I look, it&apos;s how much I&apos;ve learned about health and fitness. Knowledge that will stay with me forever.&rdquo;
                </div>
                <div>
          ...
          <div style={{ display: "flex", gap: 40 }}>
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, fontSize: 14 }}>
                <a href="https://instagram.com/tensfit_" target="_blank" rel="noopener noreferrer" style={{ color: CREAM, textDecoration: "none", display: "flex", alignItems: "center", gap: 8 }}>
                  <IconInstagram size={18} color={CREAM} />
                  @tensfit_ · Instagram ↗
                </a>
                <a href="https://tiktok.com/@tensfit_" target="_blank" rel="noopener noreferrer" style={{ color: CREAM, textDecoration: "none", display: "flex", alignItems: "center", gap: 8 }}>
                  <IconTikTok size={18} color={CREAM} />
                  @tensfit_ · TikTok ↗
                </a>
              </div>
            </div>
